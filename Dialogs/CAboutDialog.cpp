...
// Purpose:   CAboutDialog object implementation
//
//
//
// Date:      
...
// Module Level Vars
static CAboutDialog *pcabtdlgThis = NULL;
 ...
 *
 */
CAboutDialog::CAboutDialog(HINSTANCE hInstance)
{
	try
	{
		// initialize fields 
 ...
 */
LRESULT CALLBACK CAboutDialog::WindowProc (HWND hwnd, UINT uMsg, 
 ...
 *
 */
BOOL CAboutDialog::loadPreferences()
{
 ...
 *
 */
BOOL CAboutDialog::savePreferences()
{
    BOOL bReturn = TRUE;	// default to optimistic return val
 ...
 * @return
 */
BOOL CAboutDialog::setControlFonts()
{
    BOOL bReturn = TRUE;	// default to optimistic return val
 ...
 */
BOOL CAboutDialog::loadAboutText()
{
