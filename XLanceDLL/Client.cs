...
namespace XLanceDLL
{
    ...
    public struct XLV_PIPE_DATA
    {
        public int eMessageInfo;
        public int iSizeOfData;
    ...
    class Client
    {
        ...
        public delegate void MessageReceivedHandler(byte[] bytesReceived);
        ...
        public void Read()
        {
            ...
            while (true)
            {
                ...
                if (this.MessageReceived != null)
                    this.MessageReceived( readBuffer );
            }
        ...
        public void SendMessage(byte[] pipdatedataBuffer)
        {
            this.stream.Write(pipdatedataBuffer, 0, pipdatedataBuffer.Length);
            this.stream.Flush();
        }
    }
}
